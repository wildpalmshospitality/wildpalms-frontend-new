...
const footer_data: DataType[] = [
   ...
   },
   {
      ...
      footer_link: [{ link: "/listing_03", link_title: "​Buy Apartments" }, { link: "/listing_03", link_title: "Buy Condos" }, { link: "listing_03", link_title: "Rent Houses" }, { link: "listing_03", link_title: "Rent Industrial" }, { link: "/listing_03", link_title: "Buy Villas" }, { link: "/listing_03", link_title: "Rent Office" },]
   },
...

   {
      ...
      footer_link: [
         ...
         { link: "/blog_01", link_title: "Blog" }, 
         // { link: "#", link_title: "Explore Careers" }, 
         // { link: "/pricing_02", link_title: "Pricing" }, 
         // { link: "/dashboard/dashboard-index", link_title: "Dashboard" },
      ]
   },
   {
      ...
      widget_title: "Legal",
      footer_link: [
         // { link: "#", link_title: "Terms & conditions" }, 
         // { link: "#", link_title: "Cookie" }, 
         // { link: "#", link_title: "Privacy policy" }, 
   ...
   },
   {
      ...
      widget_title: "New Listing",
      footer_link: [
         { link: "listing_03", link_title: "​Buy Apartments" }, 
         { link: "listing_03", link_title: "Buy Condos" }, 
         { link: "listing_03", link_title: "Rent Houses" }, 
         { link: "listing_03", link_title: "Rent Industrial" }, 
         { link: "listing_03", link_title: "Buy Villas" }, 
         { link: "listing_03", link_title: "Rent Office" },]
   },
