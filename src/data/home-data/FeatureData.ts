...
const feature_data: DataType[] = [
   {
      ...
      title: "Buy a Home",
      btn:"Find Home",
      desc: "Explore Wildpalms to find your ideal living space from our extensive property portfolio. Whether you're buying or selling, we ensure complete transparency and offer 0% brokerage fees, making the process smooth and straightforward.",
   },
   {
      id: 2,
      page: "home_1_feature_1",
      icon: featureIcon_2,
      title: "Rent/Invest in a Home",
      btn:"Rent/Invest Home",
      desc: "Discover the perfect rental on Wildpalms using over 35 filters and tailored keywords. You can also invest in a property with a minimum investment of ₹5,000-₹10,000 and earn a guaranteed annual return of 12%. Our streamlined process ensures a rewarding experience whether you’re renting or investing.",
   },
   {
      id: 3,
      page: "home_1_feature_1",
      ...
      btn:"List Property",
      desc: "Partner with our premier real estate agency to list, rent, and thrive effortlessly. By listing your properties with us, you can become a Wildpalms affiliate and generate consistent rental income through guaranteed leads. Our streamlined process ensures success in the rental market.",
   },
